...
parser.add_argument('-d', '--decay', default=30, type=int, metavar='N',
...
def get_optimizer(model, args):
    ...
    if args.optimizer == 'FreeRexSphere':
        ...
        optimizer = freerex.FreeRexSphere(model.parameters(), args.lr,
                                weight_decay=args.weight_decay, momentum=momentum)
    ...
    if args.optimizer == 'FreeRexSphereMD':
        optimizer = freerex.FreeRexSphereMD(model.parameters(), args.lr,
                                weight_decay=args.weight_decay)
...
def main():
    ...
    if args.gpuid is not None:
        cuda_visible_devices = ", ".join([str(_) for _ in args.gpuid])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        adjust_learning_rate(optimizer, epoch, args.decay)
